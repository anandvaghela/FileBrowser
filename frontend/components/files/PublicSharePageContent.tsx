...
import { Download, FolderOpen, File, Lock, Eye, EyeOff } from 'lucide-react'
...
export default function PublicSharePageContent() {
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfd] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 bg-white rounded-xl shadow-soft w-full max-w-md overflow-hidden border border-[#e8eaed] animate-slide-up">
        {/* Header Branding */}
        <div className="px-8 py-5 border-b border-[#e8eaed] bg-gray-55/50 flex items-center justify-between">
