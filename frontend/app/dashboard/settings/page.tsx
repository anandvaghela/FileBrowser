...
import { settingsApi, usersApi, sharesApi, getUser, formatBytes } from '@/lib/api'
...
export default function SettingsPage() {
  ...
  return (
    <div className="p-6">
      ...
      {activeTab === 'shares' && (
        <div className="bg-white rounded-xl border border-[#ebebeb] p-6">
          <h2 className="text-[15px] font-bold text-[#333333] mb-5">
            Share Management
          </h2>
          {sharesLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-gray-400">
              ...
              <p className="text-sm font-bold text-gray-500">It feels lonely here...</p>
              <p className="text-xs text-gray-400 mt-1">No files or folders are currently shared.</p>
            </div>
          ) : (
