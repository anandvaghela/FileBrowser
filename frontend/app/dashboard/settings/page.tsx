                    ...
                    <div key={item.item_path} className="border border-[#f0f0f0] rounded-xl overflow-hidden">
                      ...
                      <div className="divide-y divide-[#f8f8f8]">
                        {item.users.map((u: any) => (
                          <div key={u.shared_with} className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50/50 transition-colors">
                            {/* Avatar */}
                            ...
                            <div className="relative flex-shrink-0">
                              <select
                                ...
                                className={clsx(
                                  'appearance-none text-[11px] font-semibold pl-2 pr-6 py-1 rounded-lg border cursor-pointer focus:outline-none transition-colors',
                                  u.can_write
